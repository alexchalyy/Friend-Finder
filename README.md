...
The front end of application was written in static html and styled in bootstrap to be responsive. The back end of application was written in Javascript using node.js, express, and path npm packages. The whole application was then hosted on heroku.